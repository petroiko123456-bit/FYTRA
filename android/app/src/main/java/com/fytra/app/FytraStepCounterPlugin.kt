...
class FytraStepCounterPlugin : Plugin(), SensorEventListener {
    ...
    companion object {
        ...
        const val GODMODE_GYRO_WINDOW = 4                // πόσα διαδοχικά ήδη-εγκεκριμένα "βήματα" εξετάζουμε
        const val GODMODE_GYRO_SUSPECT_THRESHOLD = 0.6   // μέσος όρος gyroPenalty πάνω από αυτό = σταθερά ύποπτο
